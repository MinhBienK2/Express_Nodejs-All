      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/bookings/checkout-session/".concat(tourId));
...
var btnTour = document.querySelectorAll('.btnTour');

if (displayMap) {
  var locationMapBox = JSON.parse(displayMap.dataset.locations);
  (0, _mapBox.mapBox)();
}
